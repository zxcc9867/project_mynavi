...
@app.route("/mypage/ticket_delete_confirm/<int:event_id>", methods=['GET','POST'])
def show_customer_ticket_delete_confirm(event_id):
    event = read_event_one(event_id)
    return render_template('/customer/mypage/customer_ticket_delete_confirm.html', event=event)
