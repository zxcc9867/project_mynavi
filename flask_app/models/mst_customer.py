...
class Mst_customer(db.Model):
    ...
    customer_account = db.Column(db.String(100))
    # customer_password = db.Column(db.String(10))  # これを消す
    customer_password = db.Column(db.String(150))
    ...
    def __repr__(self):
        return "<Mst_customer customer_id:{} customer_account:{} customer_password:{} customer_name:{} customer_zipcode:{} customer_address:{} customer_phone:{}>".format(
            self.customer_id,
